...
dataDir = fullfile('..','data','demosaic_Prokudin');

% Path to your output directory
outDir = fullfile('..','output','demosaic_Prokudin');

% List of images
imageNames = {'00125-aligned.jpg', ...
                '00149-aligned.jpg', ...
                '00153-aligned.jpg', ...
                '00351-aligned.jpg', ... 
                '00398-aligned.jpg', ...
                '01112-aligned.jpg',};%'balloon.jpeg',	'cat.jpg',	'ip.jpg','puppy.jpg','squirrel.jpg', ...
